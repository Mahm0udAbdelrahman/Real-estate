...
class ContractorCompanyProjectController extends Controller
{
    public function index()
    {
        $contractors =  Contractor::pluck('id')->first(); 
        $Companyprojects = OtherProject::where('contractor_id',$contractors)->latest()->get();
        return view('admin.dashboard.contractor_company_projects.index', compact('Companyprojects'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.dashboard.contractor_company_projects.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($contractors != null) {
            ...
            $allDataExceptImages['contractor_id'] = $contractors;
        ...
        return redirect()->route('contractor_company_projects.index');
        }else{
             
        return redirect()->back()->with('success','Plz Register Contractor Company!');
    ...
    public function edit($id)
    {
        ...
        return view('admin.dashboard.contractor_company_projects.edit', compact('project'));
    }
