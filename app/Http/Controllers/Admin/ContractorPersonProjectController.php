...
class ContractorPersonProjectController extends Controller
{
    
    public function index()
    {
        $ContractorPerson =  ContractorPerson::pluck('id')->first();
        $ContractorPerson = OtherProject::where('contractor_person_id',$ContractorPerson)->latest()->get();
        return view('admin.dashboard.contractor_person_projects.index', compact('ContractorPerson'));
    }
    ...
    {
        return view('admin.dashboard.contractor_person_projects.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        $ContractorPerson =  ContractorPerson::pluck('id')->first();
        if ($ContractorPerson != null) {
            $allDataExceptImages['contractor_person_id'] = $ContractorPerson;
            ...
            return redirect()->route('contractor_person_projects.index');
        } else {

            return redirect()->back()->with('success', 'Plz Register Contractor Person!');
        }
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.dashboard.contractor_person_projects.edit', compact('project'));
    }
