                ...
                <div class="card custom-card">
                    ...
                    <div class="card-body">
                        <table id="responsivemodal-DataTable" class="table table-bordered text-nowrap" style="width:100%">
                            <a href="{{ route('ConsultingServiceCompany.create') }}" class="btn btn-primary">Create</a>
                            <thead>
                                <tr>
                                    <th>#</th>
                            ...
                            <tbody>
                                @foreach ($register_companies as $register_company)
                                    ...
                                    <td>
                                        @php
                                        $sb=App\Models\ConsultingCompanySub::where('service_company_id',$register_company->id)->pluck('subspecialty_id');
                                    ...
                                    @endforeach
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                <a href="{{ route('ConsultingServiceCompany.edit', $register_company->id) }}"
                                                    class="btn btn-primary me-2"><i class="las la-edit"></i></a>
                                                <form method="POST"
                                                    action="{{ route('ConsultingServiceCompany.destroy', $register_company->id) }}">
                                                    @csrf
                                                    @method('delete')
