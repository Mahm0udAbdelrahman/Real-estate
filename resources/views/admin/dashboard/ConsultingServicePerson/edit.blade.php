...
@section('content')
    ...
    <div class="d-md-flex d-block align-items-center justify-content-between page-header-breadcrumb">
        <div>
            <h2 class="main-content-title fs-24 mb-1">Update Consulting Service Person</h2>
            <ol class="breadcrumb mb-0">
                <li class="breadcrumb-item"><a href="javascript:void(0)">Dashboard</a></li>
                <li class="breadcrumb-item active" aria-current="page">Consulting Service Persons</li>
            </ol>
        </div>
    ...
    <div class="row row-sm">
        <div class="col-xl-12">
            <div class="card custom-card">
                ...
                <form class="form-horizontal" method="POST" action="{{ route('ConsultingServicePerson.update', $registerConsultingServicePerson->id) }}"
                    ...
                    <div class="card-body">
                                ...
                                <div class="col-md-9">
                                    <select id="specialty" class="form-select" name="specialty_id">
                                        ...
                                        @foreach ($specialties as $specialty)
                                            <option @selected($registerConsultingServicePerson->specialty_id == $specialty->id) value="{{ $specialty->id }}">
                        ...
                        <div class="input-group mb-3">
                            <input type="email" class="form-control" value="{{ $registerConsultingServicePerson->email }}" name="email" id="basic-url" aria-describedby="basic-addon3">
                        </div>
                        @error('email')
                        ...
                        <div class="input-group mb-3">
                            <input type="text" class="form-control" value="{{ $registerConsultingServicePerson->phone }}" name="phone" id="basic-url" aria-describedby="basic-addon3">
                        </div>
                        @error('phone')
                            <div class="alert alert-danger" role="alert">{{ $message }}</div>
                        @enderror
                        ...
                        <div class="input-group mb-3">
                            <input type="text" class="form-control" value="{{ $registerConsultingServicePerson->age }}" name="age" id="basic-url" aria-describedby="basic-addon3">
                        </div>
                        @error('age')
                            <div class="alert alert-danger" role="alert">{{ $message }}</div>
                        @enderror
                        ...
                        <div class="input-group mb-3">
                            <input type="text" class="form-control" value="{{ $registerConsultingServicePerson->year_of_experience }}" name="year_of_experience" id="basic-url" aria-describedby="basic-addon3">
                        </div>
                            ...
                            <div class="row row-sm">
                                ...
                                <div class="col-md-9">
                                    <select class="form-select" name="heart">
                                        ...
                                        <option @if ($registerConsultingServicePerson->heart == 'not_favorite') selected @endif value="not_favorite">
                                            {{ __('Not Favorite') }}
                                        </option>
                                        <option @if ($registerConsultingServicePerson->heart == 'favorite') selected @endif value="favorite">
                                            {{ __('Favorite') }}
                                        </option>
                            ...
                            <div class="row row-sm">
                                ...
                                <div class="col-md-9">
                                    <select class="form-select" name="status">
                                        ...
                                        <option @if ($registerConsultingServicePerson->status == '1') selected @endif value="1">
                                            {{ __('Active') }}
                                        </option>
                                        <option @if ($registerConsultingServicePerson->status == '0') selected @endif value="0">
                                            {{ __('Unactive') }}
                                        </option>
                        ...
                        <div class="card hk-dash-type-1 overflow-hidden">
                            ...
                            <div class="tab-content" id="nav-tabContent">
                                @foreach(LaravelLocalization::getSupportedLocales() as $localeCode => $properties)
                                @php
                                $translations = $registerConsultingServicePerson->getTranslationsArray()[$localeCode] ?? [];
                                @endphp
