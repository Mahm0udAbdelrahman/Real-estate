...
@section('content')
    ...
    <div class="d-md-flex d-block align-items-center justify-content-between page-header-breadcrumb">
        <div>
            <h2 class="main-content-title fs-24 mb-1">Create ManagerCompany</h2>
            <ol class="breadcrumb mb-0">
                <li class="breadcrumb-item"><a href="javascript:void(0)">Dashboard</a></li>
                <li class="breadcrumb-item active" aria-current="page">register Manager Company</li>
            </ol>
        </div>
    </div>
    ...
    <div class="row row-sm">
        <div class="col-xl-12">
            <div class="card custom-card">
                ...
                <form class="form-horizontal" method="POST" action="{{ route('ManagerCompany.store') }}"
                    ...
                    <div class="card-body">
                        ...
                        <div class="input-group mb-3">
                            <input type="text" class="form-control" value="{{ old('number_of_employees') }}"
                        ...
                        <div class="input-group mb-3">
                            <input type="text" class="form-control" value="{{ old('number_of_branches') }}"
                        ...
                        <div class="input-group mb-3">
                            <input type="text" class="form-control" value="{{ old('year_of_experience') }}"
