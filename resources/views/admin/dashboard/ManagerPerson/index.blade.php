                ...
                <div class="card custom-card">
                    ...
                    <div class="card-body">
                        <table id="responsivemodal-DataTable" class="table table-bordered text-nowrap" style="width:100%">
                            <a href="{{ route('ManagerPerson.create') }}" class="btn btn-primary">Create</a>
                            <thead>
                                <tr>
                                    <th>#</th>
                                    <th>{{ __('full_name') }}</th>
                                    ...
                                    <th>{{ __('Phone') }}</th>
                                    <th>{{ __('Age') }}</th>
                                    <th>{{ __('year_of_experience') }}</th>
                                    <th>{{ __('academic_degree') }}</th>
                            ...
                            <tbody>
                                @foreach ($register_persons as $register_person)
                                    ...
                                    <td>
                                        @php
                                        $sb=App\Models\ManagerPersonSub::where('manager_person_id',$register_person->id)->pluck('subspecialty_id');
                                    ...
                                    @endforeach
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                <a href="{{ route('ManagerPerson.edit', $register_person->id) }}"
                                                    class="btn btn-primary me-2"><i class="las la-edit"></i></a>
                                                <form method="POST"
                                                    action="{{ route('ManagerPerson.destroy', $register_person->id) }}">
                                                    @csrf
                                                    @method('delete')
