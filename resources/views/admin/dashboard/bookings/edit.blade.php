                ...
                <form class="form-horizontal" method="POST" action="{{ route('bookings.update', $booking->id) }}"
                    ...
                    <div class="card-body">
                        ...
                        <div class="input-group mb-3">
                            <input type="date" class="form-control" value="{{ $booking->date }}" name="date"
                        ...
                        <div class="input-group mb-3">
                            <input type="time" class="form-control" value="{{ $booking->time }}" name="time"
                                id="basic-url" aria-describedby="basic-addon3">
                        </div>
                        @error('time')
                            <div class="alert alert-danger" role="alert">{{ $message }}</div>
                            ...
                            <div class="row row-sm">
                                ...
                                <div class="col-md-9">
                                    <select class="form-select" name="type">
                                        ...
                                        <option @if ($booking->type == 'call') selected @endif  value="call">Call</option>
                                        <option @if ($booking->type == 'video_call') selected @endif  value="video_call">Video Call</option>
