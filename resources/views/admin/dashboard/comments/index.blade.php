        ...
        <div class="card custom-card">
            ...
            <div class="card-body">
                <table id="responsivemodal-DataTable" class="table table-bordered text-nowrap" style="width:100%">
                    <a href="{{ route('comments.create') }}" class="btn btn-primary">Create</a>
                    <thead>
                        <tr>
                            <th>#</th>
                            <th>Name</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{ $loop->index +1  }}</td>
                                ...
                                <td>{{ $comment->{'name_' . app()->getLocale()} ?? $comment->name}}</td>
                            ...
                            <td>
                                <div class="d-flex">
                                    <a href="{{ route('comments.edit', $comment->id) }}" class="btn btn-primary me-2"><i class="las la-edit"></i></a>
                                    <form method="POST" action="{{ route('comments.destroy', $city->id) }}">
                                        @csrf
                                        @method('delete')
