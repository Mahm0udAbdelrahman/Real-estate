...
@section('content')
    ...
    <div class="d-md-flex d-block align-items-center justify-content-between page-header-breadcrumb">
        <div>
            <h2 class="main-content-title fs-24 mb-1">{{ __('Create Company') }}</h2>
                ...
                <form class="form-horizontal" method="POST" action="{{ route('companies.update' , $company->id) }}"
                    ...
                    <div class="card-body">
                                ...
                                <div class="col-md-9">
                                    <select class="form-select" name="country_id">
                                        ...
                                        @foreach ($countries as $country)
                                         <option @selected($company->country_id == $country->id ) value="{{ $country->id }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" value="{{ $company->phone }}" name="phone" id="phone"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    <select class="form-select" name="status">
                                        ...
                                        <option @if ($company->status == '1') selected @endif value="1">
                                            {{ __('Active') }}
                                        </option>
                                        <option @if ($company->status == '0') selected @endif value="0">
                                            {{ __('Unactive') }}
                                        </option>
                                    </select>
                                    @error('status')
                        ...
                        <div class="card hk-dash-type-1 overflow-hidden">
                            ...
                            <div class="tab-content" id="nav-tabContent">
                                @foreach(LaravelLocalization::getSupportedLocales() as $localeCode => $properties)
                                @php
                                $translations = $company->getTranslationsArray()[$localeCode];
                                @endphp
