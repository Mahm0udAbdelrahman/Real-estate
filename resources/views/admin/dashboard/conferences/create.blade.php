    ...
    <div class="row row-sm">
        <div class="col-xl-12">
            <div class="card custom-card">
                ...
                <form class="form-horizontal" method="POST" action="{{ route('conferences.store') }}"
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" value="{{ old('date') }}" name="date" id="date"
                        ...
                        <div class="form-group">
                            ...
                            <input type="time" class="form-control" value="{{ old('time_from') }}" name="time_from" id="time_from"
                        ...
                        <div class="form-group">
                            ...
                            <input type="time" class="form-control" value="{{ old('time_to') }}" name="time_to" id="time_to"
                                    ...
                                    <div class="tab-pane fade {{ $loop->first ? 'show active' : '' }}" id="pane-{{ $localeCode }}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="{{ $localeCode }}[about]"
                                                ...
                                                rows="5">{{ old($localeCode . '.about') }}</textarea>
