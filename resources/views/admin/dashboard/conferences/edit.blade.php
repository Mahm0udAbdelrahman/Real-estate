...
@section('content')
    ...
    <div class="d-md-flex d-block align-items-center justify-content-between page-header-breadcrumb">
        <div>
            <h2 class="main-content-title fs-24 mb-1">{{ __('Create Conference') }}</h2>
            <ol class="breadcrumb mb-0">
                <li class="breadcrumb-item"><a href="javascript:void(0)">{{ __('Dashboard') }}</a></li>
                <li class="breadcrumb-item active" aria-current="page">{{ __('Conferences') }}</li>
            </ol>
        </div>
    </div>
    <!-- Page Header Close -->
    ...
    <div class="row row-sm">
        <div class="col-xl-12">
            <div class="card custom-card">
                ...
                <form class="form-horizontal" method="POST" action="{{ route('conferences.update' , $conference->id) }}"
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" class="form-control" value="{{ $conference->image }}" name="image" id="image"
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" value="{{ $conference->date }}" name="date" id="date"
                        ...
                        <div class="form-group">
                            ...
                            <input type="time" class="form-control" value="{{ $conference->time_from }}" name="time_from" id="time_from"
                        ...
                        <div class="form-group">
                            ...
                            <input type="time" class="form-control" value="{{ $conference->time_to }}" name="time_to" id="time_to"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" value="{{ $conference->location }}" name="location" id="location"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    <select class="form-select" name="status">
                                        ...
                                        <option @if ($conference->status == '1') selected @endif value="1">
                                            {{ __('Active') }}
                                        </option>
                                        <option @if ($conference->status == '0') selected @endif value="0">
                                            {{ __('Unactive') }}
                                        </option>
                                    </select>
                                    @error('status')
                        ...
                        <div class="card hk-dash-type-1 overflow-hidden">
                            ...
                            <div class="tab-content" id="nav-tabContent">
                                @foreach(LaravelLocalization::getSupportedLocales() as $localeCode => $properties)
                                @php
                                $translations = $conference->getTranslationsArray()[$localeCode];
                                @endphp
                                    <div class="tab-pane fade {{ $loop->first ? 'show active' : '' }}" id="pane-{{ $localeCode }}"
                                        role="tabpanel" aria-labelledby="tab-{{ $localeCode }}">
                                        <div class="form-group">
                                            <label for="name-{{ $localeCode }}">{{ __('Name Conference') }} {{ $localeCode }}</label>
                                        ...
                                        <div class="form-group">
                                            <label for="about-{{ $localeCode }}">{{ __('About Conference') }} {{ $localeCode }}</label>
