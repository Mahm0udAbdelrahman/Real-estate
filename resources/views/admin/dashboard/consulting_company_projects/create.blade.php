...
<div class="d-md-flex d-block align-items-center justify-content-between page-header-breadcrumb">
    <div>
        <h2 class="main-content-title fs-24 mb-1">{{ __('Create Consulting company project') }}</h2>
        <ol class="breadcrumb mb-0">
            <li class="breadcrumb-item"><a href="javascript:void(0)">{{ __('Dashboard') }}</a></li>
            <li class="breadcrumb-item active" aria-current="page">{{ __('Consulting company projects') }}</li>
        </ol>
    </div>
</div>
<!-- Page Header Close -->
...
<div class="row row-sm">
    <div class="col-xl-12">
        <div class="card custom-card">
            ...
            @endif
            <form class="form-horizontal" method="POST" action="{{ route('consulting_company_projects.store') }}" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
