...
@section('content')
    ...
    <div class="d-md-flex d-block align-items-center justify-content-between page-header-breadcrumb">
        <div>
            <h2 class="main-content-title fs-24 mb-1">{{ __('Create Contractor Company') }}</h2>
            <ol class="breadcrumb mb-0">
                <li class="breadcrumb-item"><a href="javascript:void(0)">{{ __('Dashboard') }}</a></li>
                <li class="breadcrumb-item active" aria-current="page">{{ __('Contractor Companies') }}</li>
            </ol>
        </div>
    </div>
    <!-- Page Header Close -->
    ...
    <div class="row row-sm">
        <div class="col-xl-12">
            <div class="card custom-card">
                ...
                <form class="form-horizontal" method="POST" action="{{ route('ContractorCompany.store') }}"
                    ...
                    <div class="card-body">
                        ...
                        <div class="input-group mb-3">
                            <input type="text" class="form-control" value="{{ old('number_of_hours') }}" name="number_of_hours"
                                id="basic-url" aria-describedby="basic-addon3">
                        </div>
                                ...
                                @foreach(LaravelLocalization::getSupportedLocales() as $localeCode => $properties)
                                    <div class="tab-pane fade {{ $loop->first ? 'show active' : '' }}" id="pane-{{ $localeCode }}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ old($localeCode . '.contractor_name') }}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ old($localeCode . '.contractor_address') }}"
