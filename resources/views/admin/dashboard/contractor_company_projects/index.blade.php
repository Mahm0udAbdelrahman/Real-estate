                ...
                <div class="card custom-card">
                    ...
                    <div class="card-body">
                        <table id="responsivemodal-DataTable" class="table table-bordered text-nowrap" style="width:100%">
                            <a href="{{ route('contractor_company_projects.create') }}" class="btn btn-primary">{{ __('Create') }}</a>
                            <thead>
                                <tr>
                                    <th>#</th>
                                    <th>{{ __('Title') }}</th>
                                    ...
                                    <tr>
                                      ...
                                      <td>{{ $project->rate }}</td>
                                        ...
                                        <td>
                                            ...
                                            <td>
                                                <div class="d-flex">
                                                    <a href="{{ route('contractor_company_projects.edit', $project->id) }}"
                                                        class="btn btn-primary me-2"><i class="las la-edit"></i></a>
                                                    <form method="POST"
                                                        action="{{ route('contractor_company_projects.destroy', $project->id) }}">
                                                        @csrf
                                                        @method('delete')
