...
@section('content')
    ...
    <div class="d-md-flex d-block align-items-center justify-content-between page-header-breadcrumb">
        <div>
            <h2 class="main-content-title fs-24 mb-1">{{ __('Create Contractor Person') }}</h2>
            <ol class="breadcrumb mb-0">
                <li class="breadcrumb-item"><a href="javascript:void(0)">{{ __('Dashboard') }}</a></li>
                <li class="breadcrumb-item active" aria-current="page">{{ __('Contractor Persons') }}</li>
            </ol>
        </div>
    </div>
    <!-- Page Header Close -->
    ...
    <div class="row row-sm">
        <div class="col-xl-12">
            <div class="card custom-card">
                ...
                <form class="form-horizontal" method="POST" action="{{ route('ContractorPersons.store') }}"
                                ...
                                <div class="col-md-9">
                                    ...
                                    <select class="form-select" name="company_id">
                                        ...
                                        @foreach ($companies as $company)
                                            <option @selected(old('company_id') == $company->id) value="{{ $company->id }}">
                            ...
                            <div class="tab-content" id="nav-tabContent">
                                @foreach (LaravelLocalization::getSupportedLocales() as $localeCode => $properties)
                                    <div class="tab-pane fade {{ $loop->first ? 'show active' : '' }}"
                                        ...
                                        <div class="form-group">
                                            <label
                                                for="contractor_person_name-{{ $localeCode }}">{{ __('Contractor Person Name') }}
                                                {{ $localeCode }}</label>
                                            <input type="text"
                                                value="{{ old($localeCode . '.contractor_person_name') }}"
                                                name="{{ $localeCode }}[contractor_person_name]"
                                                id="contractor_person_name-{{ $localeCode }}" class="form-control">
                                        ...
                                        <div class="form-group">
                                            <label
                                                for="contractor_person_address-{{ $localeCode }}">{{ __('Contractor Person Address') }}
                                                {{ $localeCode }}</label>
                                            <input type="text"
                                                value="{{ old($localeCode . '.contractor_person_address') }}"
                                                name="{{ $localeCode }}[contractor_person_address]"
                                                id="contractor_person_address-{{ $localeCode }}" class="form-control">
