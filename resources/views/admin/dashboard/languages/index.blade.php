                ...
                <table id="responsivemodal-DataTable" class="table table-bordered text-nowrap" style="width:100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex">
                                    <a href="{{ route('languages.edit', $language->id) }}" class="btn btn-primary me-2"><i class="las la-edit"></i></a>
                                    <a href="{{ route('languages.show', $language->id) }}" class="btn btn-warning me-2"><i class="icon ion-md-eye"></i></a>
