                                    ...
                                    <div class="card-body mt-2 mb-2">
                                        ...
                                        <form method="POST" action="{{ route('members.store') }}">
                                            ...
                                            <div class="form-group text-start">
                                                ...
                                                <input id="name" class="form-control" placeholder="Enter your name" name="name" value="{{ old('name') }}" required autofocus autocomplete="username"  type="text">
                                            ...
                                            <div class="form-group text-start">
                                                ...
                                                <input id="email" class="form-control" placeholder="Enter your email" name="email" value="{{ old('email') }}" required autofocus autocomplete="username"  type="email">
                                            ...
                                            <div class="form-group text-start">
                                                ...
                                                <input id="phone" class="form-control" placeholder="Enter your phone" name="phone" value="{{ old('phone') }}" required autofocus autocomplete="username"  type="text">
                                            ...
                                            <div class="form-group text-start">
                                                ...
                                                <input id="birthday_date" class="form-control" placeholder="Enter your birthday_date" name="birthday_date" value="{{ old('birthday_date') }}" required autofocus autocomplete="username"  type="date">
