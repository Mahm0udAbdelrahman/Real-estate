                ...
                <table id="responsivemodal-DataTable" class="table table-bordered text-nowrap" style="width:100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $member->birthday_date }}</td>
                            <td>{{ $member->phone }}</td>
                            <td>
                                @if ($member->status == 1)
                                <span class="badge bg-success mb-1">Active</span>
                                @else
                                <span class="badge bg-secondary mb-1">Unactive</span>
                                @endif
                            </td>
                            <td>
                                <div class="d-flex">
                                    <a href="{{ route('members.edit' , $member->id) }}" class="btn btn-primary me-2"><i class="las la-edit"></i></a>
