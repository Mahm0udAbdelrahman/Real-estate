                        ...
                        <table id="responsivemodal-DataTable" class="table table-bordered text-nowrap" style="width:100%">
                            ...
                            <tbody>
                                @foreach ($packages as $package)
                                    <tr>
                                        <td>{{ $loop->index + 1 }}</td>
                                        <td>{{ $package->{'name' . app()->getLocale()} ?? $package->name }}</td>
                                        <td>{{ $package->price }}</td>
                                        <td>{{ $package->{'time' . app()->getLocale()} ?? $package->time }}</td>
                                        <td>{{ $package->{'description' . app()->getLocale()} ?? $package->description }}</td>

                                        @foreach ($package->media as $imgs)
                                            <td>
