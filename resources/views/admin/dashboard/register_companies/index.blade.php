                ...
                <div class="card custom-card">
                    ...
                    <div class="card-body">
                        <table id="responsivemodal-DataTable" class="table table-bordered text-nowrap" style="width:100%">
                            <a href="{{ route('register_companies.create') }}" class="btn btn-primary">Create</a>
                            <thead>
                                <tr>
                                    <th>#</th>
                                ...
                                @foreach ($register_companies as $register_company)
                                    ...
                                    <td>
                                        ...
                                        <td>
                                            ...
                                            {{ $register_company->bio }}
                                        </td>
                                        <td>

                                            {{ $register_company->phone }}
                                        </td>
                                        @foreach ($register_company->media as $imgs)
                                            <td>
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                <a href="{{ route('register_companies.edit', $register_company->id) }}"
                                                    class="btn btn-primary me-2"><i class="las la-edit"></i></a>
                                                <form method="POST"
                                                    action="{{ route('register_companies.destroy', $register_company->id) }}">
                                                    @csrf
                                                    @method('delete')
