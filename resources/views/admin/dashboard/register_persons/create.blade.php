...
@section('content')
    ...
    <div class="d-md-flex d-block align-items-center justify-content-between page-header-breadcrumb">
        <div>
            <h2 class="main-content-title fs-24 mb-1">Create Register Person</h2>
            <ol class="breadcrumb mb-0">
                <li class="breadcrumb-item"><a href="javascript:void(0)">Dashboard</a></li>
                <li class="breadcrumb-item active" aria-current="page">Register Persons</li>
            </ol>
        </div>
    </div>
    ...
    <div class="row row-sm">
        <div class="col-xl-12">
            <div class="card custom-card">
                ...
                <form class="form-horizontal" method="POST" action="{{ route('register_persons.store') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                            ...
                            <div class="tab-content" id="nav-tabContent">
                                @foreach(LaravelLocalization::getSupportedLocales() as $localeCode => $properties)
                                    <div class="tab-pane fade {{ $loop->first ? 'show active' : '' }}" id="pane-{{ $localeCode }}"
                                        ...
                                        <div class="form-group">
                                            <label for="name-{{ $localeCode }}">{{ __('First Name') }} {{ $localeCode }}</label>
                                            <input type="text" value="{{ old($localeCode . '.first_name') }}"
                                                name="{{ $localeCode }}[first_name]" id="name-{{ $localeCode }}"
                                                class="form-control">
                                        ...
                                        <div class="form-group">
                                            <label for="name-{{ $localeCode }}">{{ __('Last Name') }} {{ $localeCode }}</label>
                                            <input type="text" value="{{ old($localeCode . '.last_name') }}"
                                                name="{{ $localeCode }}[last_name]" id="name-{{ $localeCode }}"
                                                class="form-control">
