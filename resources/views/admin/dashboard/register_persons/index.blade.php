                ...
                <div class="card custom-card">
                    ...
                    <div class="card-body">
                        <table id="responsivemodal-DataTable" class="table table-bordered text-nowrap" style="width:100%">
                            <a href="{{ route('register_persons.create') }}" class="btn btn-primary">Create</a>
                            <thead>
                                <tr>
                                    <th>#</th>
                                    <th>{{ __('Firt Name') }}</th>
                            ...
                            <tbody>
                                @foreach ($register_persons as $register_person)
                                    <tr>
                                        <td>{{ $loop->index + 1 }}</td>
                                    <td>
                                        {{ $register_person->first_name }}

                                    </td>
                                        <td>
                                            {{ $register_person->last_name }}
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            ...
                                            @if ($register_person->gender == 'male')
                                                {{ __('Male') }}
                                            @else
                                                {{ __('Female') }}
                                            @endif
                                        ...
                                        @foreach ($register_person->media as $imgs)
                                            <td>
                                                @if($imgs)
                                                <img src="{{ $imgs->getUrl() }}" width="75" height="75" alt="NO Image">
                                            @else
                                            <img src="{{ asset('media/admin/default.png') }}" width="75" height="75" alt="NO Image">
                                            @endif
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                <a href="{{ route('register_persons.edit', $register_person->id) }}"
                                                    class="btn btn-primary me-2"><i class="las la-edit"></i></a>
                                                <form method="POST"
                                                    action="{{ route('register_persons.destroy', $register_person->id) }}">
                                                    @csrf
                                                    @method('delete')
