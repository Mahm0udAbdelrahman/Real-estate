...
@section('content')
    ...
    <div class="d-md-flex d-block align-items-center justify-content-between page-header-breadcrumb">
        <div>
            <h2 class="main-content-title fs-24 mb-1">{{ __('Update Supplier') }}</h2>
            ...
            <div class="card custom-card">
                ...
                <form class="form-horizontal" method="POST" action="{{ route('suppliers.update' , $supplier->id) }}"
                    ...
                    <div class="input-group mb-3">
                        <input type="text" class="form-control" value="{{ $supplier->location }}" name="location"
                    ...
                    @enderror
                        ...
                        <div class="input-group mb-3">
                            <input type="text" class="form-control" value="{{ $supplier->year_of_experience }}" name="year_of_experience"
                                id="basic-url" aria-describedby="basic-addon3">
                        </div>
                        ...
                        <div class="input-group mb-3">
                            <input type="text" class="form-control" value="{{ $supplier->supplied_material }}" name="supplied_material"
                                id="basic-url" aria-describedby="basic-addon3">
                        </div>
                        ...
                        <div class="input-group mb-3">
                            <input type="file" class="form-control" value="{{ $supplier->image }}" name="image"
                                id="basic-url" aria-describedby="basic-addon3">
                        </div>
                        @error('image')
                            <div class="alert alert-danger" role="alert">{{ $message }}</div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    <select class="form-select" name="status">
                                        ...
                                        <option @if ($supplier->status == '1') selected @endif value="1">
                                            {{ __('Active') }}
                                        </option>
                                        <option @if ($supplier->status == '0') selected @endif value="0">
                                            {{ __('Unactive') }}
                                        </option>
                                    </select>
                                    @error('status')
                        ...
                        <div class="card hk-dash-type-1 overflow-hidden">
                            ...
                            <div class="tab-content" id="nav-tabContent">
                                @foreach(LaravelLocalization::getSupportedLocales() as $localeCode => $properties)
                                @php
                                $translations = $supplier->getTranslationsArray()[$localeCode] ?? [];
                                @endphp
