                        ...
                        <table id="responsivemodal-DataTable" class="table table-bordered text-nowrap" style="width:100%">
                            ...
                            <tbody>
                                @foreach ($suppliers as $supplier)
                                    <tr>
                                        <td>{{ $loop->index + 1 }}</td>
                                        <td>{{ $supplier->membership_no  }}</td>
                                        <td>{{ $supplier->{'name' . app()->getLocale()} ?? $supplier->name }}</td>
                                        <td>{{ $supplier->{'location' . app()->getLocale()} ?? $supplier->location }}</td>
                                        ...
                                        <td>{{ $supplier->year_of_experience }}</td>
                                        <td>{{ $supplier->supplied_material }}</td>
                                        @foreach ($supplier->media as $imgs)
                                            <td>
