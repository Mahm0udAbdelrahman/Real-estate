        ...
        <div class="header-element country-selector">
            ...
            <a href="javascript:void(0);" class="header-link dropdown-toggle country-Flag" data-bs-auto-close="outside" data-bs-toggle="dropdown">
                <span>
                    ...
                    {{--  <img src="{{ $language->media->first()->getUrl() }}" alt="Egypt Flag" class="flag-icon w-4 h-4 me-2">  --}}
            ...
            <ul class="main-header-dropdown dropdown-menu dropdown-menu-end"  data-popper-placement="none">
                    ...
                    <li>
                        <a href="{{ route('locale',$language->abbreviations) }}" class="d-flex align-items-center">
                              <img src="{{ $language->media->first()->getUrl() }}" alt="Egypt Flag" class="flag-icon w-4 h-4 me-2">
                             {{ $language->{'name_' . app()->getLocale()} ?? $language->name }}
                        </a>
                    </li>
                    @endif
