...
<html lang="en" class="light">
    ...
    <head >
        ...
        <!-- BEGIN: CSS Assets-->
        <link rel="stylesheet" href="{{ asset('doctor/dist/css/app.css') }}" />
        <!-- END: CSS Assets-->
    </head>
    <!-- END: Head -->
    <body class="py-5 md:py-0"  dir="{{ App::getLocale() == 'ar' ? 'rtl' : 'ltr' }}">
        <!-- BEGIN: Mobile Menu -->
        <div class="mobile-menu md:hidden">
            <div class="mobile-menu-bar">
                <a href="" class="flex mr-auto">
                    <img alt="Midone - HTML Admin Template" class="w-6" src="{{ asset('doctor/dist/images/logo.svg')}}">
                </a>
        ...
        <script src="{{ asset('doctor/dist/js/app.js')}}"></script>
        <!-- END: JS Assets-->
    </body>
</html>
