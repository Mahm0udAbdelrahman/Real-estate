                    ...
                    <div class="row row-sm">
                        <div class="col-lg-6 col-xl-5 d-none d-lg-block text-center bg-primary details">
                            <div class="mt-5 pt-4 p-2 position-absolute">
                                <a href="index.html">
                                    <img src="{{ asset('dashboard/assets/images/brand-logos/desktop-white.png') }}"
                                        class="header-brand-img mb-4" alt="logo">
                                </a>
                                <div class="clearfix"></div>
                                <img src="{{ asset('dashboard/assets/images/svgs/user.svg') }}" class="ht-100 mb-0"
                                    alt="user">
                                <h5 class="mt-4">Create Your Account</h5>
                                <span class="text-white-6 fs-13 mb-5 mt-xl-0">Signup to create, discover and connect
                            ...
                            <div class="main-container container-fluid">
                                <div class="row row-sm">
                                    <div class="card-body mt-2 mb-2">
                                        <div class="clearfix"></div>
                                        <form method="POST" action="{{ route('institution.verificationcode') }}">
                                            @csrf
                                        ...
                                        <div class="text-start mt-5 ms-0">
                                            <div class="flex items-center justify-end mt-4">
                                                @if (Route::has('code.request'))
                                                    <a class="underline text-sm text-gray-600 hover:text-gray-900 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                                                        href="{{ route('code.request') }}">
                                                        {{ __('Forgot your code?') }}
                                                    </a>
                                                @endif
