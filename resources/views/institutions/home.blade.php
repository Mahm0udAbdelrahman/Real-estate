        ...
        <div class="grid grid-cols-12 gap-6">
            ...
            <div class="col-span-12 xl:col-span-4 mt-6">
                ...
                <div class="mt-5">
                    <div class="intro-y">
                        <div class="box px-4 py-4 mb-3 flex items-center zoom-in">
                            <div class="w-10 h-10 flex-none image-fit rounded-md overflow-hidden">
                                <img alt="Midone - HTML Admin Template" src="{{ asset('dashboard_institution/dist/images/profile-10.jpg')}}">
                            </div>
                    ...
                    <div class="intro-y">
                        <div class="box px-4 py-4 mb-3 flex items-center zoom-in">
                            <div class="w-10 h-10 flex-none image-fit rounded-md overflow-hidden">
                                <img alt="Midone - HTML Admin Template" src="{{ asset('dashboard_institution/dist/images/profile-7.jpg')}}">
                            </div>
                            <div class="ml-4 mr-auto">
                    ...
                    <div class="intro-y">
                        <div class="box px-4 py-4 mb-3 flex items-center zoom-in">
                            <div class="w-10 h-10 flex-none image-fit rounded-md overflow-hidden">
                                <img alt="Midone - HTML Admin Template" src="{{ asset('dashboard_institution/dist/images/profile-15.jpg')}}">
                            </div>
                            <div class="ml-4 mr-auto">
                    ...
                    <div class="intro-y">
                        <div class="box px-4 py-4 mb-3 flex items-center zoom-in">
                            <div class="w-10 h-10 flex-none image-fit rounded-md overflow-hidden">
                                <img alt="Midone - HTML Admin Template" src="{{ asset('dashboard_institution/dist/images/profile-13.jpg')}}">
                            </div>
                            <div class="ml-4 mr-auto">
            ...
            <div class="col-span-12 lg:col-span-6 mt-6">
                <div class="box p-8 relative overflow-hidden bg-primary intro-y">
                    ...
                    <img class="hidden sm:block absolute top-0 right-0 w-2/5 -mt-3 mr-2" alt="Midone - HTML Admin Template" src="{{ asset('dashboard_institution/dist/images/woman-illustration.svg')}}">
                </div>
            </div>
            <!-- END: Ads 1 -->
            <!-- BEGIN: Ads 2 -->
            <div class="col-span-12 lg:col-span-6 mt-6">
                <div class="box p-8 relative overflow-hidden intro-y">
                    ...
                    <img class="hidden sm:block absolute top-0 right-0 w-1/2 mt-1 -mr-12" alt="Midone - HTML Admin Template" src="{{ asset('dashboard_institution/dist/images/phone-illustration.svg')}}">
                </div>
            </div>
            <!-- END: Ads 2 -->
                        ...
                        <tbody>
                                ...
                                <td class="w-40">
                                    <div class="flex">
                                        <div class="w-10 h-10 image-fit zoom-in">
                                            <img alt="Midone - HTML Admin Template" class="tooltip rounded-full" src="{{ asset('dashboard_institution/dist/images/preview-8.jpg')}}" title="Uploaded at 6 February 2022">
                                        </div>
                                        <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                            <img alt="Midone - HTML Admin Template" class="tooltip rounded-full" src="{{ asset('dashboard_institution/dist/images/preview-1.jpg')}}" title="Uploaded at 30 November 2022">
                                        </div>
                                        <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                            <img alt="Midone - HTML Admin Template" class="tooltip rounded-full" src="{{ asset('dashboard_institution/dist/images/preview-15.jpg')}}" title="Uploaded at 23 April 2022">
                                        </div>
                                    </div>
                                </td>
                                <td>
                            ...
                            <tr class="intro-x">
                                <td class="w-40">
                                    <div class="flex">
                                        <div class="w-10 h-10 image-fit zoom-in">
                                            <img alt="Midone - HTML Admin Template" class="tooltip rounded-full" src="{{ asset('dashboard_institution/dist/images/preview-8.jpg')}}" title="Uploaded at 3 January 2021">
                                        </div>
                                        <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                            <img alt="Midone - HTML Admin Template" class="tooltip rounded-full" src="{{ asset('dashboard_institution/dist/images/preview-8.jpg')}}" title="Uploaded at 15 March 2021">
                                        </div>
                                        <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                            <img alt="Midone - HTML Admin Template" class="tooltip rounded-full" src="{{ asset('dashboard_institution/dist/images/preview-10.jpg')}}" title="Uploaded at 20 May 2021">
                                        </div>
                                    </div>
                                </td>
                                <td>
                            ...
                            <tr class="intro-x">
                                <td class="w-40">
                                    <div class="flex">
                                        <div class="w-10 h-10 image-fit zoom-in">
                                            <img alt="Midone - HTML Admin Template" class="tooltip rounded-full" src="{{ asset('dashboard_institution/dist/images/preview-7.jpg')}}" title="Uploaded at 21 September 2022">
                                        </div>
                                        <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                            <img alt="Midone - HTML Admin Template" class="tooltip rounded-full" src="{{ asset('dashboard_institution/dist/images/preview-7.jpg')}}" title="Uploaded at 19 December 2020">
                                        </div>
                                        <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                            <img alt="Midone - HTML Admin Template" class="tooltip rounded-full" src="{{ asset('dashboard_institution/dist/images/preview-8.jpg')}}" title="Uploaded at 20 November 2022">
                                        </div>
                                    </div>
                                </td>
                                <td>
                            ...
                            <tr class="intro-x">
                                <td class="w-40">
                                    <div class="flex">
                                        <div class="w-10 h-10 image-fit zoom-in">
                                            <img alt="Midone - HTML Admin Template" class="tooltip rounded-full" src="{{ asset('dashboard_institution/dist/images/preview-13.jpg')}}" title="Uploaded at 2 November 2020">
                                        </div>
                                        <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                            <img alt="Midone - HTML Admin Template" class="tooltip rounded-full" src="{{ asset('dashboard_institution/dist/images/preview-10.jpg')}}" title="Uploaded at 19 March 2021">
                                        </div>
                                        <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                            <img alt="Midone - HTML Admin Template" class="tooltip rounded-full" src="{{ asset('dashboard_institution/dist/images/preview-8.jpg')}}" title="Uploaded at 1 June 2021">
                                        </div>
                                    </div>
                                </td>
                                <td>
                        ...
                        <div class="intro-x relative flex items-center mb-3">
                            <div class="before:block before:absolute before:w-20 before:h-px before:bg-slate-200 before:dark:bg-darkmode-400 before:mt-5 before:ml-5">
                                <div class="w-10 h-10 flex-none image-fit rounded-full overflow-hidden">
                                    <img alt="Midone - HTML Admin Template" src="{{ asset('dashboard_institution/dist/images/profile-3.jpg')}}">
                                </div>
                            </div>
                                ...
                                <div class="text-slate-500">
                                    ...
                                    <div class="flex mt-2">
                                        <div class="tooltip w-8 h-8 image-fit mr-1 zoom-in" title="Nikon Z6">
                                            <img alt="Midone - HTML Admin Template" class="rounded-md border border-white" src="{{ asset('dashboard_institution/dist/images/preview-11.jpg')}}">
                                        </div>
                                        <div class="tooltip w-8 h-8 image-fit mr-1 zoom-in" title="Dell XPS 13">
                                            <img alt="Midone - HTML Admin Template" class="rounded-md border border-white" src="{{ asset('dashboard_institution/dist/images/preview-11.jpg')}}">
                                        </div>
                                        <div class="tooltip w-8 h-8 image-fit mr-1 zoom-in" title="Nikon Z6">
                                            <img alt="Midone - HTML Admin Template" class="rounded-md border border-white" src="{{ asset('dashboard_institution/dist/images/preview-1.jpg')}}">
                                        </div>
                                    </div>
                                </div>
                            </div>
