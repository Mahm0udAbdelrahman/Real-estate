...
<html lang="en" class="light">
    ...
    <head>
        <meta charset="utf-8">
        <link href="{{ asset('dashboard_institution/dist/images/logo.svg')}}" rel="shortcut icon">
        ...
        <!-- BEGIN: CSS Assets-->
        <link rel="stylesheet" href="{{ asset('dashboard_institution/dist/css/app.css')}}" />
        <!-- END: CSS Assets-->
    </head>
    <!-- END: Head -->
    <body class="main" dir="{{ App::getLocale() == 'ar' ? 'rtl' : 'ltr' }}">
        <!-- BEGIN: Mobile Menu -->
        ...
        <div class="top-bar-boxed h-[70px] z-[51] relative border-b border-white/[0.08] mt-12 md:-mt-5 -mx-3 sm:-mx-8 px-3 sm:px-8 md:pt-0 mb-12">
            @include('institutions.layouts.header')
        </div>
        <!-- END: Top Bar -->
        <div class="wrapper">
            <div class="wrapper-box">
                <!-- BEGIN: Side Menu -->
                @include('institutions.layouts.sidebar')
                <!-- END: Side Menu -->
                <!-- BEGIN: Content -->
                <div class="content">
                    @yield('content')
        ...
        <script src="{{asset('dashboard_institution/dist/js/app.js')}}"></script>
        <!-- END: JS Assets-->
    </body>
</html>
