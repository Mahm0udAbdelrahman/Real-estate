...
<html lang="en" dir="ltr">
  ...
  <body class="navbar-fixed sidebar-fixed"  id="body" dir="{{ App::getLocale() == 'ar' ? 'rtl' : 'ltr' }}">
    <script>
    ...
    <div class="wrapper">
        ...
        @include('members.dashboard.layouts.sidebar')
      ...
      <div class="page-wrapper">
       ...
       @yield('content')
          ...
          @include('members.dashboard.layouts.footer')
      </div>
    </div>
